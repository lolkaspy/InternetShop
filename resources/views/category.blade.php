...
@section('content')
    ...
    <form method="GET" class="row g-3 d-flex justify-content-center" action="">
        ...
        <div class="row g-3 d-flex justify-content-center">
            ...
            <div class="col-sm-2">
                <a href="{{route('category.index', ['category' => $currentCategory->slug])}}" class="btn btn-primary bg-black-pastel text-white form-control ">
                    {{ __('Сбросить фильтры') }}
                </a>
            </div>
            <div class="col-sm-2">
    ...
    @if(!$products->isEmpty())
        <table class="table text-center table-striped align-middle">
            <tr class="table-dark">
                ...
                <th>В наличии</th>
                <th></th>
                @if(Auth::check() && Auth::user()->role_id == 2)<th></th>@endif
            </tr>
