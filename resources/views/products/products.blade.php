            ...
            <form method="GET" class="row g-3 d-flex justify-content-center" action="{{route('products.index')}}">
                ...
                <div class="col-sm-2">
                    ...
                    <select name="sort_by" id="sort_by" class="form-control form-select">
                        ...
                        <option value="name" {{ (request()->sort_by == 'name') ? 'selected' : '' }}>Название товара
                        </option>
                ...
                <div class="col-sm-2">
                    ...
                    <select name="sort_order" id="sort_order" class="form-control form-select">
                        ...
                        <option value="desc" {{ (request()->sort_order == 'desc') ? 'selected' : '' }}>По убыванию
                        </option>
                    </select>
                </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('product.show', [$product->slug])}}">
                                <button class="btn btn-primary bg-black-pastel text-white">Посмотреть информацию
                                </button>
                            </a>
                        </td>
                        @user
                            <td>
                                @if($product->available_quantity > 0)
                                    <form action="{{ route('product.addToCart') }}" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-primary bg-black-pastel text-white">
                                            Добавить в корзину
                                        </button>
                                    </form>
                                @else
