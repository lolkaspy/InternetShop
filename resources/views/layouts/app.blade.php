...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item"><a class="nav-link text-white" href="{{route('catalog.index')}}">Каталог</a></li>
                        <li class="nav-item"><a class="nav-link text-white" href="{{route('products.index')}}">Все товары</a></li>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a class="text-white nav-link" href="{{route('cart.index')}}">Корзина({{\App\Models\Cart::where('user_id', Auth::id())->count()}})</a>
                            </li>
                            @endif
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle text-white" href="{{route('profile.index')}}" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::user()->name }}
                                </a>
    ...
    <footer class="text-center text-lg-start text-white fixed-bottom  bg-black-pastel">
        ...
        <div class="footer-right  d-flex justify-content-end">
            ...
            <a href="https://discordapp.com/users/164427661635092480"><img src="/images/DS.png" alt="DISCORD" class="btn img-fluid"></a>
        </div>
    </footer>
    </div>
</body>
